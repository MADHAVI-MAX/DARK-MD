...
async function connectToWA() {
  ...
  console.log("Connecting 🔱M_A_D_H_A_V_I🔱");
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("🔱M_A_D_H_A_V_I🔱 installed successful ✅");
      console.log("🔱M_A_D_H_A_V_I🔱 connected to whatsapp ✅");

      let up = `🔱M_A_D_H_A_V_I🔱 connected successful ✅`;
      let up1 = `Hello MADHAVI OWNER, I made bot successful`;
      ...
      robin.sendMessage("94772906743@s.whatsapp.net", {
        image: {
          url: `https://raw.githubusercontent.com/Dark-Robin/Bot-Helper/refs/heads/main/autoimage/Bot%20robin%20cs.jpg`,
        },
        caption: up1,
  ...
  robin.ev.on("messages.upsert", async (mek) => {
    ...
    //Owner react
    if (senderNumber.includes("94772906743")) {
      if (isReact) return;
      m.react("❤️");
    }
    //work type
...
app.get("/", (req, res) => {
  res.send("hey, 🔱M_A_D_H_A_V_I🔱 started✅");
});
app.listen(port, () =>
